...
<script type="text/javascript">
    ...
    function update(id)
    {
        var url 		= BASE_URL + 'admin/materials/form/coefficients/' + id;
...
<table class="table table-striped">
    ...
    <tbody>
    <tr>
        <?php echo form_open('admin/materials/form/coefficients/', array('id'=>'save_form'));?>
        ...
        <tr>
            ...
            <td class="text-right">
                <div class="btn-group">
                    ...
                    <a class="btn btn-danger" href="<?php echo site_url('admin/materials/delete/coefficients/'.$result->id);?>" onclick="return areyousure();" alt="<?php echo lang('delete');?>">
