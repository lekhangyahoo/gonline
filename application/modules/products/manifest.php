...
$routes[] = ['GET|POST', '/admin/products/input_data_from_link/[i:id]?/[i:copy]?', 'GoCart\Controller\AdminProducts#input_data_from_link'];
...
$routes[] = ['GET|POST', '/product/calculator_price_again/[:slug]', 'GoCart\Controller\Product#calculator_price_again'];
