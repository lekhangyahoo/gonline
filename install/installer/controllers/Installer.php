...
class Installer extends CI_Controller {
	...
	public function init()
	{
		...
		$errors .= (!$testIntl)?'<div class="alert alert-danger" role="alert">The PHP_INTL Library is required for Gonline and is not installed on your server. <a href="http://php.net/manual/en/book.intl.php">Read More</a></div>':'';
